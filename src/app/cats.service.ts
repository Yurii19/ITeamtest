...
export class CatsService {
  ...
  //BASE_URL = 'https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=beng&api_key=REPLACE_ME'

  constructor(private http: HttpClient) { }

  getCats(params : any =''): any{
   return this.http.get(`${this.BASE_URL}/images/search?${params}api_key=${this.API_KEY}`)
  }
